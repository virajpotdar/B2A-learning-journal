      ...
      <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem' }}>
        <div style={{ 
          ...
          <p style={{ color: '#ef6c00', fontSize: '1.1rem', margin: 0 }}>
            Explore your backend development insights
          </p>
        </div>
        ...
        <div style={{ marginBottom: '2rem', display: 'flex', gap: '1rem', alignItems: 'center' }}>
          <button
            ...
            style={{
              padding: '12px 24px',
              background: viewMode === 'graph' ? '#f57c00' : 'white',
              color: viewMode === 'graph' ? 'white' : '#f57c00',
          ...
          <button
            ...
            style={{
              padding: '12px 24px',
              background: viewMode === 'list' ? '#f57c00' : 'white',
              color: viewMode === 'list' ? 'white' : '#f57c00',
              border: '2px solid #f57c00',
              borderRadius: '8px',
              fontSize: '16px',
              fontWeight: 'bold',
